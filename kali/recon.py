...
if choice == "1":
     ...
     if choice == "1":
          ...
          os.system('python goofile.py -d '+domain+' -f doc > tmp')
          os.system('python goofile.py -d '+domain+' -f docx >> tmp')
          os.system('python goofile.py -d '+domain+' -f pdf >> tmp')          
          os.system('python goofile.py -d '+domain+' -f ppt >> tmp')
          os.system('python goofile.py -d '+domain+' -f pptx >> tmp')
          os.system('python goofile.py -d '+domain+' -f txt >> tmp')          
          os.system('python goofile.py -d '+domain+' -f xls >> tmp')
          os.system('python goofile.py -d '+domain+' -f xlsx >> tmp')
