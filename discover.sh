...
case $choice in
	...
	/pentest/enumeration/web/urlcrazy/urlcrazy $domain -o tmp > /dev/null
     ...
     sleep 1
     firefox -new-tab http://www.urlvoid.com/scan/$domain.org/ &
     sleep 1
...
sed 's/Direct Dial Available//g' $location | sed 's/\[\]//g; s/Apple Valley//g; s/Artesia//g; s/Atlanta//g; s/Austin//g; s/Baltimore//g; s/Birmingham//g; s/Boston//g; s/Burbank//g ; s/Camp Springs//g; s/Chicago//g; s/Cincinnati//g; s/Cleveland//g; s/CNN News Group Cable News Network//g; s/Dallas//g; s/Department of Treasury//g; s/Department of the Treasury//g; s/Department of The Treasury//g; s/Dunkirk//g; s/Emeryville//g; s/Encino//g; s/Gardena//g; s/Gastonia//g; s/Harbor City//g; s/Hawthorne//g; s/Hermosa Beach//g; s/Herndon//g; s/Hyattsville//g; s/Irvine//g; s/JA//g; s/Kansas City//g; s/La Plata//g; s/Lawndale//g; s/Lithonia//g; s/Lomita//g; s/London//g; s/Long Beach//g; s/Los Angeles//g; s/Manhattan//g; s/Marietta//g; s/Marina Del Rey//g; s/Mc Lean//g; s/Miami//g; s/Mumbai India//g; s/Needham//g; s/New York//g; s/Oakland//g; s/Orange//g; s/Philadelphia//g; s/Portland//g; s/Rancho//g; s/Redondo Beach//g; s/Richmond//g; s/Riverdale//g; s/Rllng Hls Est//g; s/Rockville//g; s/Sacramento//g; s/Salt Lake City//g; s/San Diego//g; s/San Francisco//g; s/San Jose//g; s/San Pedro//g; s/Santa Monica//g; s/Seattle//g; s/Sitka//g; s/South Lake//g; s/Stillwater//g; s/Tacoma//g; s/Torrance//g; s/U.S.//g; s/U.S. Department of Treasury//g; s/United Kingdom//g; s/United States//g; s/Vienna//g; s/Walnut Creek//g; s/Washington//g; s/Westport//g; s/Williamsport//g; s/Wilmington//g; s/Winder//g; s/AK//g; s/AL//g; s/AR//g; s/AZ//g; s/CA//g; s/CO//g; s/CT//g; s/DC//g; s/DE//g; s/FL//g; s/GA//g; s/HI//g; s/IA//g; s/ID//g; s/IL//g; s/IN//g; s/KS//g; s/KY//g; s/LA//g; s/MA//g; s/ME//g; s/MD//g; s/MI//g; s/MN//g; s/MO//g; s/MS//g; s/MT//g; s/NC//g; s/NE//g; s/ND//g; s/NH//g; s/NJ//g; s/NM//g; s/NV//g; s/NY//g; s/OH//g; s/OK//g; s/OR//g; s/PA//g; s/RI//g; s/SC//g; s/SD//g; s/TN//g; s/TX//g; s/UT//g; s/VA//g; s/VT//g; s/WA//g; s/WI//g; s/WV//g; s/WY//g; s/[0-9]\{2\}\/[0-9]\{2\}\/[0-9]\{2\}//g; s/^[ \t]*//' > tmp
